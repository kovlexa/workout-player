const WARMUP = [
  ...
  { id:'wu-hinge', name:'Hip hinge без веса', target:'8 повторений', type:'timed', durationSec:60, sets:1, media:'hipHinge', cue:'Таз назад, колени слегка согнуты. Особенно следи за ощущениями справа в пояснице/ягодице.' },
  { id:'wu-band', name:'Сведение лопаток / Band pull-apart', target:'10 повторений', type:'timed', durationSec:60, sets:1, media:'bandPullApart', cue:'Слабая резинка. Плечи подальше от ушей, движение подконтрольное.' }
];

const WORKOUTS = {
  A: {
    id:'A', title:'Тренировка A', subtitle:'Базовая сила', transitionSec:90, equipment:['гантель','турник','резинка','скакалка'], warmup:true,
    exercises:[
      ...
      {id:'a-deadbug',name:'Dead bug',sets:3,target:'6–10 на сторону',type:'reps',restSec:60,restLabel:'45–60 сек',media:'deadBug',cue:'Противоположные рука и нога опускаются медленно. Поясница остаётся под контролем.'}
    ]
  },
  B: {
    id:'B', title:'Тренировка B', subtitle:'Задняя цепь + верх', transitionSec:90, equipment:['гантели','турник','резинка','скакалка'], warmup:true,
    exercises:[
      ...
      {id:'b-band',name:'Разведение резинки',sets:3,target:'12–20 повторений',type:'reps',restSec:60,restLabel:'45–60 сек',media:'bandPullApart',cue:'Своди лопатки, не поднимай плечи к ушам и не прогибай поясницу.'},
  ...
  C: {
    id:'C', title:'Тренировка C', subtitle:'Облегчённая Full Body', transitionSec:90, equipment:['гантели','турник','скакалка','устойчивая опора'], warmup:true,
    exercises:[
      {id:'c-bulgarian',name:'Болгарский сплит-присед',sets:3,target:'8 на каждую ногу',type:'reps',restSec:90,restLabel:'90 сек',media:'bulgarian',cue:'Первые тренировки без гантелей. Если завтра футбол — в приложении можно включить режим 2×8.'},
      ...
      {id:'c-deadbug',name:'Dead bug',sets:2,target:'8 на сторону',type:'reps',restSec:60,restLabel:'45–60 сек',media:'deadBug',cue:'Медленно, поясница под контролем.'},
  ...
  P: {
    id:'P', title:'Осанка', subtitle:'8–10 минут · 4–6 раз в неделю', transitionSec:30, equipment:['слабая резинка','стена','коврик'], warmup:false,
    exercises:[
      {id:'p-wall',name:'Wall slide',sets:2,target:'8–10 повторений',type:'reps',restSec:45,restLabel:'30–45 сек',media:'wallSlide',cue:'Плавное движение вверх-вниз. Не пытайся силой прижать всё тело к стене.'},
      {id:'p-band',name:'Band pull-apart',sets:2,target:'15 повторений',type:'reps',restSec:45,restLabel:'30–45 сек',media:'bandPullApart',cue:'Слабая резинка, контролируй лопатки.'},
      {id:'p-deadbug',name:'Dead bug',sets:2,target:'6 на сторону',type:'reps',restSec:45,restLabel:'30–45 сек',media:'deadBug',cue:'Медленно, без отрыва контроля поясницы.'},
      {id:'p-chin',name:'Chin tuck',sets:2,target:'8 повторений',type:'reps',restSec:30,restLabel:'30 сек',media:'chinTuck',cue:'Голова движется назад, а не вниз. Только комфортная амплитуда, без продавливания боли.'}
    ]
  }
};